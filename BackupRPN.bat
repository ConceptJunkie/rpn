...
set RPN_FILES=rpn*.py;makeHelp.py;makeRPNPrimes.py;makeUnits.py;makeConstants.py;setup_rpn.py;test*.py;profile*.py;rpnTest.txt;rpn.ico;rpn32.iss;rpn64.iss;BuildRPN.bat;BuildRPNInstaller.bat;tox.ini;pyecm.py;requirements.txt;setup.cfg;MANIFEST.in;setup.py;unpickle.py;preparePrimeData.py;BackupRPN.bat;rpnConstants.txt
