...
massTable = {
    mpmathify( '4.2e-37' )      : 'the mass equivalent of the energy of a photon at the peak of the spectrum of the cosmic microwave background radiation (0.235 meV/c2)',
    mpmathify( '1.8e-33' )      : 'the mass equivalent of one electronvolt (1 eV/c^2)',
    mpmathify( '3.6e-33' )      : 'the mass of an electron neutrino, (upper limit, 2 eV/c2)',
    mpmathify( '9.11e-28' )     : 'the mass of an electron (511 keV/c2), the lightest elementary particle with a measured nonzero rest mass',
    mpmathify( '5.5e-27' )      : 'the mass of an up quark (as a current quark, upper limit of 1.7-3.1 MeV/c2)',
    mpmathify( '1.9e-25' )      : 'the mass of a muon (106 MeV/c2)',
    mpmathify( '1.661e-24' )    : 'the atomic mass unit (u) or dalton (Da)',
    mpmathify( '1.673e-24' )    : 'the mass of proton (938.3 MeV/c2)',
    mpmathify( '1.674e-24' )    : 'the mass of a hydrogen atom, the lightest atom',
    mpmathify( '1.675e-24' )    : 'the mass of a neutron (939.6 MeV/c2)',
    mpmathify( '1.2e-23' )      : 'the mass of a lithium atom (6.941 u)',
    mpmathify( '3.0e-23' )      : 'the mass of a water molecule (18.015 u)',
    mpmathify( '8.0e-23' )      : 'the mass of a titanium atom (47.867 u)',
    mpmathify( '1.1e-22' )      : 'the mass of a copper atom (63.546 u)',
    mpmathify( '1.6e-22' )      : 'the mass of a Z boson (91.2 GeV/c2)',
    mpmathify( '3.1e-22' )      : 'the mass of a top quark (173 GeV/c2), the heaviest known elementary particle',
    mpmathify( '3.2e-22' )      : 'the mass of a caffeine molecule (194 u)',
    mpmathify( '3.5e-22' )      : 'the mass of a lead-208 atom, the heaviest stable isotope known',
    mpmathify( '1.2e-21' )      : 'the mass of a buckyball molecule (720 u)',
    mpmathify( '1.4e-20' )      : 'the mass of ubiquitin, a small protein (8.6 kDa)[13]',
    mpmathify( '5.5e-20' )      : 'the mass of a typical protein (median size of roughly 300 amino acids ~= 33 kDa)',
    mpmathify( '1.1e-19' )      : 'the mass of a hemoglobin A molecule in blood (64.5 kDa)',
    mpmathify( '1.65e-18' )     : 'the mass of a double-stranded DNA molecule consisting of 1,578 base pairs (995,000 daltons)',
    mpmathify( '4.3e-18' )      : 'the mass of a prokaryotic ribosome (2.6 MDa)',
    mpmathify( '7.1e-18' )      : 'the mass of a eukaryotic ribosome (4.3 MDa)',
    mpmathify( '7.6e-18' )      : 'the mass of a Brome mosaic virus, a small virus (4.6 MDa)',
    mpmathify( '3.0e-17' )      : 'the mass of the Synaptic vesicle in rats (16.1 +/- 3.8 MDa)',
    mpmathify( '6.8e-17' )      : 'the mass of the Tobacco mosaic virus (41 MDa)',
    mpmathify( '1.1e-16' )      : 'the mass of the nuclear pore complex in yeast (66 MDa)',
    mpmathify( '2.5e-16' )      : 'the mass of a Human adenovirus (150 MDa)',
    mpmathify( '1.0e-15' )      : 'the mass of an HIV-1 virus',
    mpmathify( '4.7e-15' )      : 'the mass of a DNA sequence of length 4.6 Mbp, the length of the E. coli genome',
    mpmathify( '1.0e-14' )      : 'the mass of a Vaccinia virus, a large virus',
    mpmathify( '1.1e-14' )      : 'the mass equivalent of 1 joule',
    mpmathify( '3.0e-13' )      : 'the mass of a Prochlorococcus cyanobacteria, the smallest photosynthetic organism on Earth',
    mpmathify( '1.0e-12' )      : 'the mass of an E. coli bacterium (wet weight)',
    mpmathify( '6.0e-12' )      : 'the mass of DNA in a typical diploid human cell (approximate)',
    mpmathify( '2.2e-11' )      : 'the mass of a human sperm cell',
    mpmathify( '6.0e-11' )      : 'the mass of a yeast cell (quite variable)',
    mpmathify( '1.5e-10' )      : 'the mass of a Dunaliella salina, a green algae (dry weight)',
    mpmathify( '1.0e-9' )       : 'the mass of an average human cell (1 nanogram)',
    mpmathify( '8.0e-9' )       : 'the mass of a grain of birch pollen',
    mpmathify( '2.5e-7' )       : 'the mass of a grain of maize pollen',
    mpmathify( '3.5e-7' )       : 'the mass of a very fine grain of sand (0.063 mm diameter, 350 nanograms)',
    mpmathify( '3.6e-6' )       : 'the mass of a human ovum',
    mpmathify( '2.0e-5' )       : 'the uncertainty in the mass of the International Prototype Kilogram (IPK) (+/-20 ug)',
    mpmathify( '2.2e-5' )       : 'the Planck mass',
    mpmathify( '7.0e-5' )       : 'the mass of one eyebrow hair (approximate)',
    mpmathify( '2.5e-4' )       : 'the mass of a fruit fly (dry weight)',
    mpmathify( '2.5e-3' )       : 'the mass of a mosquito, common smaller species (about 2.5 milligrams)',
    mpmathify( '2.0e-2' )       : 'the mass of an adult housefly (Musca domestica, 21.4 milligrams)',
    mpmathify( '2.0e-1' )       : 'one metric carat (200 milligrams)',
    mpmathify( '0.5' )          : 'the mass of a raisin (approximately 0.5 gram)',
    mpmathify( '1.0' )          : 'the mass of one cubic centimeter of water (1 gram)',
    mpmathify( '1.0' )          : 'the mass of a U.S. dollar bill (1 gram)',
    mpmathify( '7.5' )          : 'the mass of a Euro coin (7.5 grams)',
    mpmathify( '8.1' )          : 'the mass of a U.S. dollar coin (8.1 grams)',
    mpmathify( '28.35' )        : 'one ounce (avoirdupois) (28.35 grams)',
    mpmathify( '4.7e1' )        : 'the mass equivalent of one megaton of TNT equivalent',
    mpmathify( '1.5e2' )        : 'the mass of a typical orange (100-200 grams)',
    mpmathify( '4.54e2' )       : 'one pound (avoirdupois) (454 grams)',
    mpmathify( '1.0e3' )        : 'the mass of one litre of water',
    mpmathify( '2.0e3' )        : 'the mass of a Chihuahua, the smallest breed of dog (Chihuahua)',
    mpmathify( '3.25e3' )       : 'the mass of a newborn human baby',
    mpmathify( '4.0e3' )        : 'the mass of a women\'s shot',
    mpmathify( '4.5e3' )        : 'the mass of a typical housecat',
    mpmathify( '7.26e3' )       : 'the mass of a men\'s shot',
    mpmathify( '1.8e4' )        : 'the mass of a medium-sized dog',
    mpmathify( '2.0e4' )        : 'the mass of a typical CRT computer monitor',
    mpmathify( '1.8e5' )        : 'the mass of a typical mature male lion, female (130 kg) and male (180 kg)',
    mpmathify( '3.5e5' )        : 'the mass of a typical grand piano',
    mpmathify( '6.5e5' )        : 'the mass of a typical dairy cow',
    mpmathify( '9.072e5' )      : 'one short ton (2000 pounds - U.S.)',
    mpmathify( '1.0e6' )        : 'one metric ton/tonne, 1 cubic metre of water',
    mpmathify( '1.2e6' )        : 'the mass of a typical passenger cars',
    mpmathify( '5.5e6' )        : 'the mass of an average male African bush elephant',
    mpmathify( '1.1e7' )        : 'the mass of the Hubble Space Telescope (11 tonnes)',
    mpmathify( '1.2e7' )        : 'the mass of the largest elephant on record (12 tonnes)',
    mpmathify( '1.4e7' )        : 'the mass of Big Ben\'s bell (14 tonnes)',
    mpmathify( '4.4e7' )        : 'the maximum gross mass (truck + load combined) of a semi-trailer truck in the EU (40-44 tonnes)',
    mpmathify( '7.3e7' )        : 'the mass of the largest dinosaur, Argentinosaurus (73 tonnes)',
    mpmathify( '1.8e8' )        : 'the mass of the blue whale, the largest animal ever (180 tonnes)',
    mpmathify( '4.2e8' )        : 'the mass of the International Space Station (417 tonnes)',
    mpmathify( '4.39985e8' )    : 'the mass of the takeoff weight of a Boeing 747-8',
    mpmathify( '6.0e8' )        : 'the mass of the world\'s heaviest aircraft: Antonov An-225 (maximum take-off mass: 600 tonnes, payload: 250 tonnes)',
    mpmathify( '1.0e9' )        : 'the mass of the trunk of the giant sequoia tree, "General Sherman", largest living tree by trunk volume (1121 tonnes)',
    mpmathify( '2.041e9' )      : 'the launch mass of the Space Shuttle (2041 tonnes)',
    mpmathify( '6.0e9' )        : 'the mass of the largest clonal colony, the quaking aspen named Pando (largest living organism, 6000 tonnes)',
    mpmathify( '7.8e9' )        : 'the mass of a Virginia-class nuclear submarine (submerged weight)',
    mpmathify( '1.0e10' )       : 'the mass of the annual production of Darjeeling tea',
    mpmathify( '5.2e10' )       : 'the mass of the RMS Titanic when fully loaded (52,000 tonnes)',
    mpmathify( '9.97e10' )      : 'the mass of the heaviest train ever, Australia\'s BHP Iron Ore, 2001 record (99,700 tonnes)',
    mpmathify( '6.6e11' )       : 'the mass of the largest ship and largest mobile man-made object, Seawise Giant, when fully loaded (660,000 tonnes)',
    mpmathify( '4.3e12' )       : 'the mass of matter converted into energy by the Sun each second',
    mpmathify( '6.0e12' )       : 'the mass of the Great Pyramid of Giza',
    mpmathify( '6.0e13' )       : 'the mass of the concrete in the Three Gorges Dam, the world\'s largest concrete structure',
    mpmathify( '1.0e14' )       : 'the mass of a primordial black hole with an evaporation time equal to the age of the universe',
    mpmathify( '2.0e14' )       : 'the mass of the amount of water stored in London storage reservoirs (0.2 km3)',
    mpmathify( '4.0e14' )       : 'the total mass of the human world population',
    mpmathify( '5.0e14' )       : 'the total biomass of Antarctic krill',
    mpmathify( '1.55e15' )      : 'the global biomass of fish (estaimted)',
    mpmathify( '4.0e15' )       : 'the mass of the world crude oil production in 2009 (3,843 Mt)',
    mpmathify( '5.5e15' )       : 'the mass of a teaspoon (5 ml) of neutron star material (5.5 billion tonnes)',
    mpmathify( '1.0e16' )       : 'the mass of a 1km tall mountain (very approximate)',
    mpmathify( '1.05e17' )      : 'the total mass of carbon fixed in organic compounds by photosynthesis each year on Earth',
    mpmathify( '7.2e17' )       : 'the mass of the total carbon stored in Earth\'s atmosphere',
    mpmathify( '2.0e18' )       : 'the mass of the total carbon stored in the terrestrial biosphere',
    mpmathify( '3.5e18' )       : 'the mass of the total carbon stored in coal deposits worldwide',
    mpmathify( '1.0e19' )       : 'the mass of the total carbon content of all organisms on Earth (rough estimate)',
    mpmathify( '3.8e19' )       : 'the mass of the total carbon stored in the oceans',
    mpmathify( '1.6e20' )       : 'the mass of Prometheus, a shepherd satellite for the inner edge of Saturn\'s F Ring',
    mpmathify( '5.1e21' )       : 'the mass of the Earth\'s atmosphere',
    mpmathify( '5.6e21' )       : 'the mass of Hyperion, a moon of Saturn',
    mpmathify( '3.0e22' )       : 'the mass of Juno, the third largest asteroid in the asteroid belt',
    mpmathify( '3.0e22' )       : 'the mass of the rings of Saturn',
    mpmathify( '9.4e23' )       : 'the mass of Ceres, the largest asteroid in the asteroid belt',
    mpmathify( '1.4e24' )       : 'the mass of the Earth\'s oceans',
    mpmathify( '1.5e24' )       : 'the mass of Charon, the largest moon of Pluto',
    mpmathify( '3.3e24' )       : 'the mass of the Asteroid Belt',
    mpmathify( '1.3e25' )       : 'the mass of Pluto',
    mpmathify( '2.1e25' )       : 'the mass of Triton, largest moon of Neptune',
    mpmathify( '7.3e25' )       : 'the mass of Earth\'s Moon',
    mpmathify( '1.3e26' )       : 'the mass of Titan, largest moon of Saturn',
    mpmathify( '1.5e26' )       : 'the mass of Ganymede, largest moon of Jupiter',
    mpmathify( '3.3e26' )       : 'the mass of Mercury',
    mpmathify( '6.4e26' )       : 'the mass of Mars',
    mpmathify( '4.9e27' )       : 'the mass of Venus',
    mpmathify( '6.0e27' )       : 'the mass of Earth',
    mpmathify( '3.0e28' )       : 'the mass of Oort cloud',
    mpmathify( '8.7e28' )       : 'the mass of Uranus',
    mpmathify( '1.0e29' )       : 'the mass of Neptune',
    mpmathify( '5.7e29' )       : 'the mass of Saturn',
    mpmathify( '1.9e30' )       : 'the mass of Jupiter',
    mpmathify( '8.0e31' )       : 'the mass of a typical brown dwarf',
    mpmathify( '3.0e32' )       : 'the mass of Barnard\'s Star, a nearby red dwarf',
    mpmathify( '2.0e33' )       : 'the mass of the Sun',
    mpmathify( '2.8e33' )       : 'the mass of Chandrasekhar limit (1.4 solar masses)',
    mpmathify( '4.0e34' )       : 'the mass of Betelgeuse, a red supergiant star (20 solar masses)',
    mpmathify( '2.5e35' )       : 'the mass of Pistol Star, one of the most massive known stars',
    mpmathify( '1.6e36' )       : 'the Pleiades star cluster (800 solar masses)',
    mpmathify( '1.0e38' )       : 'the mass of a typical globular cluster in the Milky Way',
    mpmathify( '2.4e39' )       : 'the mass of the Gould Belt of stars, including the Sun (1.2e6 solar masses)',
    mpmathify( '7.5e39' )       : 'the mass of the black hole at the center of the Milky Way, associated with the radio source Sagittarius A* (3.7 +/- 0.2e6 solar masses)',
    mpmathify( '4.17e43' )      : 'the mass of NGC 4889, the largest measured supermassive black hole (2.1e10 solar masses)',
    mpmathify( '4.0e44' )       : 'the visible mass of the Milky Way galaxy',
    mpmathify( '1.2e45' )       : 'the mass of Milky Way galaxy (5.8e11 solar masses)',
    mpmathify( '2.5e45' )       : 'the mass of the Local Group of galaxies, including the Milky Way',
    mpmathify( '1.5e48' )       : 'the mass of the Local or Virgo Supercluster of galaxies, including the Local Group',
    mpmathify( '6.0e55' )       : 'the mass of the observable universe',
}
