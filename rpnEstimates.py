...
chargeTable = {
    ...
    mpf( '1' )          : 'a 1 coulomb charge: two negative point charges of 1 C, placed one meter apart, would experience a repulsive force of 9 GN',
...
currentTable = {
    ...
    mpf( '5' )          : 'the current draw of a typical 12 V motor vehicle headlight (typically 60 W)',
...
electricPotentialTable = {
    ...
    mpf( '6' )          : 'the common voltage for medium-size electric lanterns (6 V)',
...
illuminanceTable = {
    ...
    mpf( '1' )          : 'the illuminance of the extreme of darkest storm clouds at sunset/sunrise',
...
luminanceTable = {
    ...
    mpf( '2' )      : 'the luminance of floodlit buildings, monuments, and fountains',
    mpf( '5' )      : 'the approximate luminance of the mesopic/photopic threshold',
...
luminousIntensityTable = {
    ...
    mpf( '1' )      : 'the approximate luminous intensity of a candle',
...
magneticFluxDensityTable = {
    ...
    mpf( '3' )          : 'the magnetic flux density of a common magnetic resonance imaging system',
