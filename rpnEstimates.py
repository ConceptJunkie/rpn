...
areaTable = {
    ...
    mpf( '440000' )     : 'the area of Vatican City',
...
dataRateTable = {
    mpf( '5.0e-2' )     : 'the Project ELF bit rate for transmitting 3-letter codes to U.S. nuclear submarines',
...
informationEntropyTable = {
    ...
    mpf( '1.58496' )        : 'approximate size of a trit (a base-3 digit, log2( 3 )',
    ...
    mpf( '1.47573e20' )     : 'the maximum addressable memory using 64-bit addresses without segmentation; the maximum volume and filesize for ZFS filesystem',
...
lengthTable = {
    ...
    mpf( '3.1e-19' )        : 'the de Broglie wavelength of protons at the Large Hadron Collider (4 TeV as of 2012)',
    ...
    mpf( '1.0e-10' )        : '1 Angstrom (also covalent radius of sulfur atom)',
    mpf( '1.54e-10' )       : 'the length of a typical covalent bond (C-C)',
    mpf( '5.00e-10' )       : 'the width of protein alpha helix',
    ...
    mpf( '1.216e-7' )       : 'the wavelength of the Lyman-alpha line',
    mpf( '4.075e-7' )       : 'the center wavelength of violet light',
    mpf( '6.825e-5' )       : 'the center wavelength of red light',
    mpf( '2.0e-6' )         : 'particle size that a surgical mask removes at 80-95% efficiency',
    ...
    mpf( '7.5e-4' )         : 'the maximum diameter of Thiomargarita namibiensis, the largest bacterium ever discovered',
    ...
    mpf( '0.00762' )        : 'a common military ammunition size',
    mpf( '0.0254' )         : '1 inch',
    mpf( '0.04267' )        : 'the diameter of a golf ball',
    mpf( '0.1' )            : 'the wavelength of the highest UHF radio frequency, 3 GHz',
    mpf( '0.3048' )         : '1 foot',
    mpf( '0.9144' )         : '1 yard',
    mpf( '1' )              : 'the wavelength of the lowest UHF and highest VHF radio frequency, 300 MHz',
    mpf( '1.7' )            : 'the average height of a human',
    mpf( '8.38' )           : 'the length of a London Bus (Routemaster)',
    mpf( '10' )             : 'the wavelength of the lowest VHF and highest shortwave radio frequency, 30 MHz',
    ...
    mpf( '100' )            : 'the wavelength of the lowest shortwave radio frequency and highest medium wave radio frequency, 3 MHz',
    ...
    mpf( '1.0e3' )          : 'the wavelength of the lowest medium wave radio frequency, 300 kHz',
    mpf( '1.609e3' )        : '1 international mile',
    mpf( '1.852e3' )        : '1 nautical mile',
    ...
    mpf( '42194.988' )      : 'the length of marathon',
    ...
    mpf( '4.0075e7' )       : 'length of the Earth\'s equator',
    mpf( '1.42984e8' )      : 'diameter of Jupiter',
    mpf( '299792458' )      : 'distance travelled by light in one second',
    mpf( '3.84e8' )         : 'the Moon\'s orbital distance from Earth',
    mpf( '1.39e9' )         : 'diameter of the Sun',
    mpf( '4.2e9' )          : 'the greatest mileage ever recorded by a car (A 1966 Volvo P-1800S, still driving)',
    mpf( '1.79875e10' )     : 'the approximately one light-minute',
    mpf( '1.4959787e11' )   : '1 astronomical unit (AU); mean distance between Earth and Sun',
    ...
    mpf( '2.37e12' )        : 'median point of the optical diameter of UY Scuti, as of 2014 the largest known star',
    mpf( '5.9e12' )         : 'orbital distance of Pluto from Sun',
    ...
    mpf( '9.46e15' )        : '1 light year, the distance travelled by light in one year; at its current speed, Voyager 1 would need 17,500 years to travel this distance',
    mpf( '3.0857e16' )      : '1 parsec',
...
radiationEquivalentDoseTable = {
    ...
    mpf( '4.6e-4' )     : 'estimated largest off-site dose possible from March 28, 1979 Three Mile Island accident',
    ...
    mpf( '1.0e-3' )     : 'the limit of annual dose from man-made sources to a member of the public who is not a radiation worker in the USA and Canada',
    ...
    mpf( '1' )          : 'the hourly exposure level reported during Fukushima I nuclear accidents, in immediate vicinity of reactor',
    mpf( '3' )          : 'the thyroid dose (due to iodine absorption) exclusion zone criteria for US nuclear reactor siting (converted from 300 rem)',
    ...
    mpf( '5.0' )        : 'the exposure calculated from the estimated 510 rem dose fatally received by Harry Daghlian on 1945 August 21 at Los Alamos and lower estimate for fatality of Russian specialist on 1968 April 5 at Chelyabinsk-70',
    mpf( '5.0' )        : 'a level of exposure most commercial electronics can survive (5 - 10 Sv)',
    mpf( '21' )         : 'the exposure calculated from the estimated 2100 rem dose fatally received by Louis Slotin on 1946 May 21 at Los Alamos and lower estimate for fatality of Russian specialist on 1968 April 5 Chelyabinsk-70',
    mpf( '48.5' )       : 'the roughly calculated exposure from the estimated 4500 + 350 rad dose for fatality of Russian experimenter on 1997 June 17 at Sarov',
    mpf( '60.0' )       : 'the roughly calculated exposure from the estimated 6000 rem doses for several Russian fatalities from 1958 onwards, such as on 1971 May 26 at the Kurchatov Institute. Lower estimate for a Los Alamos fatality in 1958 December 30.',
    mpf( '100' )        : 'the roughly calculated exposure from the estimated 10000 rad dose for fatality at the United Nuclear Fuels Recovery Plant on 1964 July 24',
