...
densityTable = {
    ...
    mpf( '2.0e-11' )    : 'the density of the Sun\'s corona',
    mpf( '1.0e-10' )    : 'the density at top of the Solar transition region',
    ...
    mpf( '90' )         : 'the density of Hydrogen gas, the least dense substance at STP',
    mpf( '160' )        : 'the density of Earth\'s atmosphere at 16 km altitude',
    mpf( '180' )        : 'the density of aerographite',
    mpf( '900' )        : 'the density of an ultralight metallic microlattice',
    mpf( '1.10e3' )     : 'the lowest density achieved for an aerogel',
    mpf( '1.48e3' )     : 'the density of Earth\'s atmosphere at sea level',
    ...
    mpf( '5.35e5' )     : 'the density of lithium (Li)',
    mpf( '7.00e5' )     : 'the typical density of wood',
    mpf( '8.60e5' )     : 'the density of potassium (K)',
    mpf( '9.167e5' )    : 'the density of water ice at temperatures < 0 degrees C',
    mpf( '9.70e5' )     : 'the density of sodium (Na)',
    mpf( '1.000e6' )    : 'the density of liquid water at 4 degrees C',
    mpf( '1.030e6' )    : 'the density of salt water',
    mpf( '1.062e6' )    : 'the average density of the human body',
    mpf( '1.261e6' )    : 'the density of glycerol',
    mpf( '1.408e6' )    : 'the average density of the Sun',
    mpf( '1.622e6' )    : 'the density of tetrachloroethene',
    mpf( '1.740e6' )    : 'the density of magnesium (Mg)',
    mpf( '1.850e6' )    : 'the density of beryllium (Be)',
    mpf( '2.000e6' )    : 'the density of concrete',
    mpf( '2.330e6' )    : 'the density of silicon',
    mpf( '2.700e6' )    : 'the density of aluminium',
    mpf( '3.325e6' )    : 'the density of diiodomethane (liquid at room temperature)',
    mpf( '3.500e6' )    : 'the density of diamond',
    mpf( '4.540e6' )    : 'the density of titanium',
    mpf( '4.800e6' )    : 'the density of selenium',
    mpf( '5.515e6' )    : 'the average density of the Earth',
    mpf( '6.100e6' )    : 'the density of vanadium',
    mpf( '6.690e6' )    : 'the density of antimony',
    mpf( '7.000e6' )    : 'the density of zinc',
    mpf( '7.200e6' )    : 'the density of chromium',
    mpf( '7.310e6' )    : 'the density of tin',
    mpf( '7.325e6' )    : 'the density of manganese',
    mpf( '7.870e6' )    : 'the density of iron',
    mpf( '8.570e6' )    : 'the density of niobium',
    mpf( '8.600e6' )    : 'the density of brass',
    mpf( '8.650e6' )    : 'the density of cadmium',
    mpf( '8.900e6' )    : 'the density of cobalt',
    mpf( '8.900e6' )    : 'the density of nickel',
    mpf( '8.940e6' )    : 'the density of copper (Cu)',
    mpf( '9.750e6' )    : 'the density of bismuth (Bi)',
    mpf( '1.0220e7' )   : 'the density of molybdenum (Mo)',
    mpf( '1.0500e7' )   : 'the density of silver (Ag)',
    mpf( '1.1340e7' )   : 'the density of lead (Pb)',
    mpf( '1.1700e7' )   : 'the density of thorium (Th)',
    mpf( '1.2410e7' )   : 'the density of rhodium (Rh)',
    mpf( '1.3546e7' )   : 'the density of mercury (Hg)',
    mpf( '1.6600e7' )   : 'the density of tantalum (Ta)',
    mpf( '1.8800e7' )   : 'the density of uranium (U)',
    mpf( '1.9300e7' )   : 'the density of tungsten (W)',
    mpf( '1.9320e7' )   : 'the density of gold (Au)',
    mpf( '1.9840e7' )   : 'the density of plutonium (Pu)',
    mpf( '2.1450e7' )   : 'the density of platinum (Pt)',
    mpf( '2.2420e7' )   : 'the density of iridium (Ir)',
    mpf( '2.2590e7' )   : 'the density of osmium (Os), the densest known substance at STP',
    mpf( '4.1000e7' )   : 'the estimated density of Hassium (Hs), assuming that an isotope featuring a long half-life exists',
    mpf( '1.5e8' )      : 'the density of the core of the Sun',
    mpf( '1.0e12' )     : 'the density of a white dwarf',
    mpf( '2.0e16' )     : 'the approximate density of the universe at end of the electroweak epoch',
    mpf( '2.0e20' )     : 'the density of atomic nuclei and neutron stars',
    mpf( '1.0e26' )     : 'the density of a hypothetical preon star',
    mpf( '5.1e99' )     : 'the Planck density',
}
