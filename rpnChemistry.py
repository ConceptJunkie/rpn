...
def loadChemistryTables( ):
    g.elements = {
        ...
        95 :  [ 'Americium',      'Am',  3,   7,   'f',  'Solid',   'Synthetic',   'Actinide',                mpmathify( '1' ),           mpmathify( '1', )     ],
        96 :  [ 'Curium',         'Cm',  3,   7,   'f',  'Solid',   'Synthetic',   'Actinide',                mpmathify( '1' ),           mpmathify( '1', )     ],
        97 :  [ 'Berkelium',      'Bk',  3,   7,   'f',  'Solid',   'Synthetic',   'Actinide',                mpmathify( '1' ),           mpmathify( '1', )     ],
        98 :  [ 'Californium',    'Cf',  3,   7,   'f',  'Solid',   'Synthetic',   'Actinide',                mpmathify( '1' ),           mpmathify( '1', )     ],
        99 :  [ 'Einsteinium',    'Es',  3,   7,   'f',  'Solid',   'Synthetic',   'Actinide',                mpmathify( '1' ),           mpmathify( '1', )     ],
        100 : [ 'Fermium',        'Fm',  3,   7,   'f',  'unknown', 'Synthetic',   'Actinide',                mpmathify( '1' ),           mpmathify( '1', )     ],
        101 : [ 'Mendelevium',    'Md',  3,   7,   'f',  'unknown', 'Synthetic',   'Actinide',                mpmathify( '1' ),           mpmathify( '1', )     ],
        102 : [ 'Nobelium',       'No',  3,   7,   'f',  'unknown', 'Synthetic',   'Actinide',                mpmathify( '1' ),           mpmathify( '1', )     ],
        103 : [ 'Lawrencium',     'Lr',  3,   7,   'd',  'unknown', 'Synthetic',   'Actinide',                mpmathify( '1' ),           mpmathify( '1', )     ],
        104 : [ 'Rutherfordium',  'Rf',  4,   7,   'd',  'unknown', 'Synthetic',   'Transition metal',        mpmathify( '1' ),           mpmathify( '1', )     ],
        105 : [ 'Dubnium',        'Db',  5,   7,   'd',  'unknown', 'Synthetic',   'Transition metal',        mpmathify( '1' ),           mpmathify( '1', )     ],
        106 : [ 'Seaborgium',     'Sg',  6,   7,   'd',  'unknown', 'Synthetic',   'Transition metal',        mpmathify( '1' ),           mpmathify( '1', )     ],
        107 : [ 'Bohrium',        'Bh',  7,   7,   'd',  'unknown', 'Synthetic',   'Transition metal',        mpmathify( '1' ),           mpmathify( '1', )     ],
        108 : [ 'Hassium',        'Hs',  8,   7,   'd',  'unknown', 'Synthetic',   'Transition metal',        mpmathify( '1' ),           mpmathify( '1', )     ],
        109 : [ 'Meitnerium',     'Mt',  9,   7,   'd',  'unknown', 'Synthetic',   'unknown',                 mpmathify( '1' ),           mpmathify( '1', )     ],
        110 : [ 'Darmstadtium',   'Ds',  10,  7,   'd',  'unknown', 'Synthetic',   'unknown',                 mpmathify( '1' ),           mpmathify( '1', )     ],
        111 : [ 'Roentgenium',    'Rg',  11,  7,   'd',  'unknown', 'Synthetic',   'unknown',                 mpmathify( '1' ),           mpmathify( '1', )     ],
        112 : [ 'Copernicium',    'Cn',  12,  7,   'd',  'unknown', 'Synthetic',   'Transition metal',        mpmathify( '1' ),           mpmathify( '1', )     ],
        113 : [ 'Nihonium',       'Nh',  13,  7,   'p',  'unknown', 'Synthetic',   'unknown',                 mpmathify( '1' ),           mpmathify( '1', )     ],
        114 : [ 'Flerovium',      'Fl',  14,  7,   'p',  'unknown', 'Synthetic',   'Post-transition metal',   mpmathify( '1' ),           mpmathify( '1', )     ],
        115 : [ 'Moscovium',      'Mc',  15,  7,   'p',  'unknown', 'Synthetic',   'unknown',                 mpmathify( '1' ),           mpmathify( '1', )     ],
        116 : [ 'Livermorium',    'Lv',  16,  7,   'p',  'unknown', 'Synthetic',   'unknown',                 mpmathify( '1' ),           mpmathify( '1', )     ],
        117 : [ 'Tennessine',     'Ts',  17,  7,   'p',  'unknown', 'Synthetic',   'unknown',                 mpmathify( '1' ),           mpmathify( '1', )     ],
        118 : [ 'Oganesson',      'Og',  18,  7,   'p',  'unknown', 'Synthetic',   'unknown',                 mpmathify( '1' ),           mpmathify( '1', )     ],
    }
