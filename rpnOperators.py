...
constants = {
    ...
    'apery_constant'                : RPNOperator( lambda: apery,
                                                   0, [ ] ),
    'catalan_constant'              : RPNOperator( lambda: catalan,
                                                   0, [ ] ),
    'champernowne_constant'         : RPNOperator( getChampernowneConstant,
                                                   0, [ ] ),
    'copeland_erdos_constant'       : RPNOperator( getCopelandErdosConstant,
                                                   0, [ ] ),
    'e'                             : RPNOperator( lambda: e,
                                                   0, [ ] ),
    'eddington_number'              : RPNOperator( lambda: fmul( 136, power( 2, 256 ) ),
                                                   0, [ ] ),
    'euler_mascheroni_constant'     : RPNOperator( lambda: euler,
                                                   0, [ ] ),
    'glaisher_constant'             : RPNOperator( lambda: glaisher,
                                                   0, [ ] ),
    'infinity'                      : RPNOperator( lambda: inf,
                                                   0, [ ] ),
    'itoi'                          : RPNOperator( lambda: exp( fmul( -0.5, pi ) ),
                                                   0, [ ] ),
    'khinchin_constant'             : RPNOperator( lambda: khinchin,
                                                   0, [ ] ),
    'merten_constant'               : RPNOperator( lambda: mertens,
                                                   0, [ ] ),
    ...
    'omega_constant'                : RPNOperator( lambda: lambertw( 1 ),
                                                   0, [ ] ),
    'phi'                           : RPNOperator( lambda: phi,
                                                   0, [ ] ),
    'pi'                            : RPNOperator( lambda: pi,
                                                   0, [ ] ),
