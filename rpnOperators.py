...
operators = {
    ...
    'next_first_quarter_moon'       : OperatorInfo( getNextFirstQuarterMoon, 1 ),
    'next_full_moon'                : OperatorInfo( getNextFullMoon, 1 ),
    'next_last_quarter_moon'        : OperatorInfo( getNextLastQuarterMoon, 1 ),
    'next_new_moon'                 : OperatorInfo( getNextNewMoon, 1 ),
    ...
    'previous_first_quarter_moon'   : OperatorInfo( getPreviousFirstQuarterMoon, 1 ),
    'previous_full_moon'            : OperatorInfo( getPreviousFullMoon, 1 ),
    'previous_last_quarter_moon'    : OperatorInfo( getPreviousLastQuarterMoon, 1 ),
    'previous_new_moon'             : OperatorInfo( getPreviousNewMoon, 1 ),
