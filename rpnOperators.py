...
operators = {
    ...
    'next_first_quarter_moon'       : OperatorInfo( getPreviousLastQuarterMoon, 1 ),
    'next_full_moon'                : OperatorInfo( getPreviousLastQuarterMoon, 1 ),
    'next_last_quarter_moon'        : OperatorInfo( getPreviousLastQuarterMoon, 1 ),
    'next_new_moon'                 : OperatorInfo( getPreviousLastQuarterMoon, 1 ),
    ...
    'previous_first_quarter_moon'   : OperatorInfo( getPreviousLastQuarterMoon, 1 ),
    'previous_full_moon'            : OperatorInfo( getPreviousLastQuarterMoon, 1 ),
    'previous_last_quarter_moon'    : OperatorInfo( getPreviousLastQuarterMoon, 1 ),
    'previous_new_moon'             : OperatorInfo( getPreviousLastQuarterMoon, 1 ),
