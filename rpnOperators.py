...
operators = {
    ...
    'fine_structure_constant'       : OperatorInfo( lambda: mpmathify( '0.0072973526' ), 0 ),
    ...
    'planck_area'                   : OperatorInfo( lambda: RPNMeasurement( mpmathify( '2.6121003e-70' ),  [ { 'square_meter' : 1 } ] ), 0 ),
    ...
    'planck_density'                : OperatorInfo( lambda: RPNMeasurement( mpmathify( '5.15500e99' ), [ { 'gram' : 1 }, { 'meter' : -3 } ] ), 0 ),
    'planck_energy'                 : OperatorInfo( lambda: RPNMeasurement( mpmathify( '1.956e9' ),  [ { 'joule' : 1 } ] ), 0 ),
    'planck_energy_density'         : OperatorInfo( lambda: RPNMeasurement( mpmathify( '4.63298e113' ), [ { 'joule' : 1 }, { 'meter' : -3 } ] ), 0 ),
    'planck_force'                  : OperatorInfo( lambda: RPNMeasurement( mpmathify( '1.21027e44' ), [ { 'newton' : 1 } ] ), 0 ),
    ...
    'planck_length'                 : OperatorInfo( lambda: RPNMeasurement( mpmathify( '1.616199e-35' ),  [ { 'meter' : 1 } ] ), 0 ),
    'planck_mass'                   : OperatorInfo( lambda: RPNMeasurement( mpmathify( '2.17651e-8' ), [ { 'gram' : 1 } ] ), 0 ),
    ...
    'planck_temperature'            : OperatorInfo( lambda: RPNMeasurement( mpmathify( '1.416833e32' ), [ { 'kelvin' : 1 } ] ), 0 ),
    'planck_time'                   : OperatorInfo( lambda: RPNMeasurement( mpmathify( '5.39106e-44' ),  [ { 'second' : 1 } ] ), 0 ),
    'planck_voltage'                : OperatorInfo( lambda: RPNMeasurement( mpmathify( '1.04295e27' ), [ { 'volt' : 1 } ] ), 0 ),
    'planck_volume'                 : OperatorInfo( lambda: RPNMeasurement( mpmathify( '4.22419e-105' ), [ { 'cubic_meter' : 1 } ] ), 0 ),
    ...
    'proton_mass'                   : OperatorInfo( lambda: RPNMeasurement( mpmathify( '1.007276466812' ), [ { 'dalton' : 1 } ] ), 0 ),
    'proton_mass'                   : OperatorInfo( lambda: RPNMeasurement( mpmathify( '1.6726218e-24' ), [ { 'gram' : 1 } ] ), 0 ),
    'radiation_constant'            : OperatorInfo( lambda: RPNMeasurement( mpmathify( '7.5657e-16' ), [ { 'joule' : 1 }, { 'meter' : -3 }, { 'kelvin' : -4 } ] ), 0 ),
    'reduced_planck_constant'       : OperatorInfo( lambda: RPNMeasurement( mpmathify( '6.626070040e-34' ), [ { 'joule' : 1 }, { 'second' : 1 } ] ) / fmul( 2, pi ), 0 ),
