...
operators = {
    ...
    'decagonal_centered_square'     : OperatorInfo( lambda n: getNthDecagonalCenteredSquareNumber( n ), 1 ),
    'decagonal_heptagonal'          : OperatorInfo( lambda n: getNthDecagonalHeptagonalNumber( n ), 1 ),
    'decagonal_hexagonal'           : OperatorInfo( lambda n: getNthDecagonalHexagonalNumber( n ), 1 ),
    'decagonal_nonagonal'           : OperatorInfo( lambda n: getNthDecagonalNonagonalNumber( n ), 1 ),
    'decagonal_octagonal'           : OperatorInfo( lambda n: getNthDecagonalOctagonalNumber( n ), 1 ),
    'decagonal_pentagonal'          : OperatorInfo( lambda n: getNthDecagonalPentagonalNumber( n ), 1 ),
    'decagonal_triangular'          : OperatorInfo( lambda n: getNthDecagonalTriangularNumber( n ), 1 ),
    ...
    'n_fibonacci'                   : OperatorInfo( getNthNFibonacciNumber, 2 ),
    ...
    'nth_centered_polygonal'        : OperatorInfo( lambda n, k: findCenteredPolygonalNumber( n, k ), 2 ),
    ...
    'octanacci'                     : OperatorInfo( getNthOctanacci, 1 ),
