...
operators = {
    ...
    'nthprime?'             : OperatorInfo( lambda n: findPrime( n )[ 0 ], 1 ),
    'nthquad?'              : OperatorInfo( lambda n: findQuadrupletPrimes( n )[ 0 ], 1 ),
    ...
    'quadprime?'            : OperatorInfo( lambda n: findQuadrupletPrimes( n )[ 1 ], 1 ),
    ...
    'unitroots'             : OperatorInfo( lambda n: unitroots( int( n ) ), 1 ),
    'unlist'                : OperatorInfo( unlist, 1 ),
