...
operators = {
    ...
    'next_centered_decagonal'       : OperatorInfo( lambda n: findCenteredPolygonalNumber( n, 10 ), 1 ),
    'next_centered_heptagonal'      : OperatorInfo( lambda n: findCenteredPolygonalNumber( n, 7 ), 1 ),
    'next_centered_hexagonal'       : OperatorInfo( lambda n: findCenteredPolygonalNumber( n, 6 ), 1 ),
    'next_centered_nonagonal'       : OperatorInfo( lambda n: findCenteredPolygonalNumber( n, 9 ), 1 ),
    'next_centered_octagonal'       : OperatorInfo( lambda n: findCenteredPolygonalNumber( n, 8 ), 1 ),
    'next_centered_pentagonal'      : OperatorInfo( lambda n: findCenteredPolygonalNumber( n, 5 ), 1 ),
    'next_centered_polygonal'       : OperatorInfo( lambda n, k: findCenteredPolygonalNumber( n, k ), 2 ),
    'next_centered_square'          : OperatorInfo( lambda n: findCenteredPolygonalNumber( n, 4 ), 1 ),
    'next_centered_triangular'      : OperatorInfo( lambda n: findCenteredPolygonalNumber( n, 3 ), 1 ),
    'next_decagonal'                    : OperatorInfo( lambda n: findNthPolygonalNumber( n, 10 ), 1 ),
    ...
    'next_heptagonal'               : OperatorInfo( lambda n: findNthPolygonalNumber( n, 7 ), 1 ),
    'next_hexagonal'                : OperatorInfo( lambda n: findNthPolygonalNumber( n, 6 ), 1 ),
    ...
    'next_nonagonal'                : OperatorInfo( lambda n: findNthPolygonalNumber( n, 9 ), 1 ),
    'next_octagonal'                : OperatorInfo( lambda n: findNthPolygonalNumber( n, 8 ), 1 ),
    'next_pentagonal'               : OperatorInfo( lambda n: findNthPolygonalNumber( n, 5 ), 1 ),
    'next_polygonal'                : OperatorInfo( findNthPolygonalNumber, 2 ),
    'next_prime'                    : OperatorInfo( lambda n: findPrime( n )[ 1 ], 1 ),
    'next_prime_index'              : OperatorInfo( lambda n: findPrime( n )[ 0 ], 1 ),
    'next_quadruplet_prime'         : OperatorInfo( lambda n: findQuadrupletPrimes( n )[ 1 ], 1 ),
    'next_quadruplet_prime_index'   : OperatorInfo( lambda n: findQuadrupletPrimes( n )[ 0 ], 1 ),
    ...
    'next_triangular'               : OperatorInfo( lambda n: findNthPolygonalNumber( n, 3 ), 1 ),
