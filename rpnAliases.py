...
operatorAliases = {
    ...
    'cdec?'                     : 'next_centered_decagonal',
    'cdecagonal'                : 'centered_decagonal',
    'cdecagonal?'               : 'next_centered_decagonal',
    'ceil'                      : 'ceiling',
    'centeredcube'              : 'centered_cube',
    'centered_decagonal?'       : 'next_centered_decagonal',
    'centered_heptagonal?'      : 'next_centered_heptagonal',
    'centered_hexagonal?'       : 'next_centered_hexagonal',
    'centered_nonagonal?'       : 'next_centered_nonagonal',
    'centered_octagonal?'       : 'next_centered_octagonal',
    'centered_pentagonal?'      : 'next_centered_pentagonal',
    'centered_polygonal?'       : 'next_centered_polygonal',
    'centered_square?'          : 'next_centered_square',
    'centered_triangular?'      : 'next_centered_triangular',
    'champ'                     : 'champernowne',
    'chept'                     : 'centered_heptagonal',
    'chept?'                    : 'next_centered_heptagonal',
    'cheptagonal'               : 'centered_heptagonal',
    'cheptagonal?'              : 'next_centered_heptagonal',
    'chex'                      : 'centered_hexagonal',
    'chex?'                     : 'next_centered_hexagonal',
    'chexagonal'                : 'centered_hexagonal',
    'chexagonal?'               : 'next_centered_hexagonal',
    'civil_dawn'                : 'dawn',
    'civil_dusk'                : 'dusk',
    'click'                     : 'kilometer',
    'cnon'                      : 'centered_nonagonal',
    'cnon?'                     : 'next_centered_nonagonal',
    'cnonagonal'                : 'centered_nonagonal',
    'cnonagonal?'               : 'next_centered_nonagonal',
    'coct'                      : 'coctagonal',
    'coct?'                     : 'next_centered_octagonal',
    'coctagonal'                : 'centered_octagonal',
    'coctagonal?'               : 'next_centered_octagonal',
    ...
    'cpent?'                    : 'next_centered_pentagonal',
    'cpentagonal'               : 'centered_pentagonal',
    'cpentagonal?'              : 'next_centered_pentagonal',
    'cpoly'                     : 'centered_polygonal',
    'cpoly?'                    : 'next_centered_polygonal',
    'cpolygonal'                : 'centered_polygonal',
    'cpolygonal?'               : 'next_centered_polygonal',
    'csqr'                      : 'centered_square',
    'csqr?'                     : 'next_centered_square',
    'csquare'                   : 'centered_square',
    'csquare?'                  : 'next_centered_square',
    'ctri'                      : 'centered_triangular',
    'ctri?'                     : 'next_centered_triangular',
    'ctriangular'               : 'centered_triangular',
    'ctriangular'               : 'centered_triangular',
    'ctriangular?'              : 'next_centered_triangular',
    'cuberoot'                  : 'cube_root',
    'c_cube'                    : 'centered_cube',
    'c_dec'                     : 'centered_decagonal',
    'c_dec?'                    : 'next_centered_decagonal',
    'c_decagonal'               : 'centered_decagonal',
    'c_decagonal?'              : 'next_centered_decagonal',
    'c_hept'                    : 'centered_heptagonal',
    'c_hept?'                   : 'next_centered_heptagonal',
    'c_heptagonal'              : 'centered_heptagonal',
    'c_heptagonal?'             : 'next_centered_heptagonal',
    'c_hexagonal'               : 'centered_hexagonal',
    'c_hexagonal?'              : 'next_centered_hexagonal',
    'c_non'                     : 'centered_nonagonal',
    'c_non?'                    : 'next_centered_nonagonal',
    'c_nonagonal'               : 'centered_nonagonal',
    'c_nonagonal?'              : 'next_centered_nonagonal',
    'c_oct'                     : 'centered_octagonal',
    'c_oct?'                    : 'next_centered_octagonal',
    'c_octagonal'               : 'centered_octagonal',
    'c_octagonal?'              : 'next_centered_octagonal',
    'c_pent'                    : 'centered_pentagonal',
    'c_pent?'                   : 'next_centered_pentagonal',
    'c_pentagonal'              : 'centered_pentagonal',
    'c_pentagonal?'             : 'next_centered_pentagonal',
    'c_poly'                    : 'centered_polygonal',
    'c_poly?'                   : 'next_centered_polygonal',
    'c_polygonal'               : 'centered_polygonal',
    'c_polygonal?'              : 'next_centered_polygonal',
    'c_sqr'                     : 'centered_square',
    'c_sqr?'                    : 'next_centered_square',
    'c_square'                  : 'centered_square',
    'c_square?'                 : 'next_centered_square',
    'c_tri'                     : 'centered_triangular',
    'c_tri?'                    : 'next_centered_triangular',
    'c_triangular'              : 'centered_triangular',
    'deca'                      : 'decagonal',
    'deca?'                     : 'next_decagonal',
    'decagonal?'                : 'next_decagonal',
    'diff'                      : 'diffs',
    ...
    'hept'                      : 'heptagonal',
    'hept?'                     : 'next_heptagonal',
    'heptagonal?'               : 'next_heptagonal',
    ...
    'next_quad_index'           : 'next_quadruplet_prime_index',
    'ninf'                      : 'negative_infinity',
    'nint'                      : 'nearest_int',
    'nlimit'                    : 'limit',
    'non'                       : 'nonagonal',
    'non?'                      : 'next_nonagonal',
    'nonagonal?'                : 'next_nonagonal',
    ...
    'nthprime'                  : 'prime',
    'nthprime?'                 : 'next_prime_index',
    'nthquad?'                  : 'next_quadruplet_prime_index',
    'nthweekday'                : 'nth_weekday',
    'nthweekdayofyear'          : 'nth_weekday_of_year',
    'nth_prime'                 : 'next_prime_index',
    'nth_prime?'                : 'next_prime_index',
    'nth_quad?'                 : 'next_quadruplet_prime_index',
    'octa'                      : 'octagonal',
    'octa?'                     : 'next_octagonal',
    ...
    'polyeval'                  : 'eval_poly',
    'polygonal?'                : 'next_polygonal',
    'polyval'                   : 'eval_poly',
    'poly_10_3'                 : 'decagonal_triangular',
    'poly_10_4'                 : 'decagonal_square',
